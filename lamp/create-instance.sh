...
aws ec2 run-instances --image-id $AMZLINUZ2_AMI --count 1 --instance-type t2.micro --key-name  $MYSSHKEYNAME --tag-specifications ResourceType=string,Tags=[{Key=Name,Value=lamp}]
